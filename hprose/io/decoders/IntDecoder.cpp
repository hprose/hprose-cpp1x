...
int64_t IntDecode(Reader &reader, char tag) {
    switch (tag) {
        ...
        case tags::TagLong:     return readInt64(reader);
        case tags::TagDouble:   return readDoubleAsInt(reader);
        case tags::TagUTF8Char: return readUTF8CharAsInt(reader);
        case tags::TagString:   return readStringAsInt(reader);
        case tags::TagDate:     return readDateTimeAsInt(reader);
        case tags::TagTime:     return readTimeAsInt(reader);
        case tags::TagRef:      return readRefAsInt(reader);
